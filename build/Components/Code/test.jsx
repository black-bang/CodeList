...
class test extends React.Component {
  ...
  onTouchEnd = () => {
    ...
    console.log(this.position[this.index]);
    delete this.mouseXY;
  ...
  render() {
    const liChildren = this.state.dataArray.map((item) => {
     ...
     // console.log(key)
      ...
      >
        {/* <div className={`${this.props.className}-updata`}>
          <a onClick={(e) => { this.onUpdata(e); }}>修改</a>
        </div> */}
        ...
        >
          <div className={`${this.props.className}-img`}>
            <img src={img} width="45" height="45" onDragStart={e => e.preventDefault()} />
          </div>
          <p>{text}</p>
        </TweenOne>
      </li>);
